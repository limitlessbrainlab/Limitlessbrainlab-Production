-- =====================================================
-- CREATE SUPER ADMIN: sweta.adatia@gmail.com
-- =====================================================
-- Run this in Supabase Dashboard → SQL Editor
-- Project: puzdgwtprcpaaxxwkwtk (limitlessbrainlab.com)
-- Idempotent: safe to re-run (updates password if user exists)
-- =====================================================
...
BEGIN
  ...
  IF user_exists THEN
    -- ── User already exists: get their ID and (re)set password + role ──
...
WHERE u.email = 'sweta.adatia@gmail.com';
