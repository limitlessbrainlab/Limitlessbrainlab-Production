-- Create clinical_reports table for storing detailed clinical assessment reports
-- This table stores comprehensive clinical reports for patients
...
CREATE TABLE clinical_reports (
  ...
  patient_uid TEXT, -- Patient UID in format: CLINICCODE-YYYYMM-XXXX
  org_id UUID, -- Organization/Clinic ID (removed FK constraint as organizations table may not exist)
  clinic_name TEXT,
  ...
  -- Neurosense Brain Health Parameters (13 parameters)
  brain_parameters JSONB, -- Store all 13 parameters as JSON
...
-- Policy: Allow authenticated users to view all reports (you can customize this later)
