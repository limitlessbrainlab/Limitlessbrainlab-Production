          ...
          <div className="sm:col-span-2 md:col-span-1 space-y-4 sm:space-y-6 flex flex-col items-center sm:items-start">
            ...
            <div className="w-full flex flex-col items-center sm:items-start">
              ...
              <div className="flex gap-3">
                ...
                <a href="https://w.app/labchat" target="_blank" rel="noopener noreferrer" className="w-9 h-9 sm:w-8 sm:h-8 bg-gray-800 hover:bg-gray-700 rounded-full flex items-center justify-center transition-colors">
