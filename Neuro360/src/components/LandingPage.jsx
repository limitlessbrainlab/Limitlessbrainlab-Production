          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
            ...
            <div>
              ...
              <div className="flex space-x-4">
                ...
                <a href="https://www.youtube.com/@drsweta.adatia" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-[#0066CC] transition-colors" title="YouTube English">
                  <Youtube className="h-5 w-5" />
                </a>
                <a href="https://www.youtube.com/@drsweta.adatiahindi" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-red-800 rounded-full flex items-center justify-center hover:bg-red-700 transition-colors" title="YouTube Hindi">
                  <Youtube className="h-5 w-5" />
                </a>
