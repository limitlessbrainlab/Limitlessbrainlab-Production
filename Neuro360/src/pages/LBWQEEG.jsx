            ...
            <>
              ...
              <div className="bg-white rounded-2xl shadow-lg p-8 mb-8">
                ...
                <div className="space-y-4">
                  {[
                    { name: 'Delta', range: 'Slowest waves', level: 15, status: 'normal', desc: 'Deep sleep & body healing', color: 'blue' },
                    { name: 'Theta', range: 'Slow waves', level: 25, status: 'normal', desc: 'Meditation & creativity', color: 'purple' },
                    { name: 'Alpha', range: 'Medium waves', level: 35, status: 'optimal', desc: 'Relaxed focus & calm', color: 'green' },
                    { name: 'Beta', range: 'Fast waves', level: 45, status: 'elevated', desc: 'Active thinking & focus', color: 'yellow' },
                    { name: 'Gamma', range: 'Fastest waves', level: 20, status: 'normal', desc: 'Learning & memory', color: 'red' }
                  ].map((wave, index) => (
                    <div key={index}>
                ...
                {[
                  {
                    ...
                    target: 'Focus & attention training',
                    recommended: true,
                  ...
                  },
                  {
                    ...
                    target: 'Relaxation wave training',
                    recommended: false,
                  ...
                  },
                  {
                    ...
                    target: 'Full brain optimization',
                    recommended: true,
                  ...
                  },
                  {
                    ...
                    target: 'Deep relaxation training',
                    recommended: false,
