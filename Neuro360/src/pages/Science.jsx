...
const Science = () => {
  return (
    <div className="min-h-screen bg-white flex flex-col">
      ...
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-[#F5D05D] text-white pt-32 pb-20">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-6">
            The Science Behind Limitless Brain Lab
          </h1>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-4xl mx-auto mt-12">
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
              <div className="text-4xl font-bold text-[#F5D05D]">50+</div>
              <div className="text-sm text-gray-200 mt-2">Years of Research</div>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
              <div className="text-4xl font-bold text-[#F5D05D]">2,000+</div>
              <div className="text-sm text-gray-200 mt-2">Published Studies</div>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
              <div className="text-4xl font-bold text-[#F5D05D]">Level 1</div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-20">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="order-2 md:order-1">
                <div className="inline-flex items-center gap-2 bg-[#F5D05D]/10 text-[#F5D05D] px-4 py-2 rounded-full mb-6">
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    <div className="flex-shrink-0 w-8 h-8 bg-[#F5D05D] rounded-lg flex items-center justify-center mt-1">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <p className="text-lg text-gray-700 leading-relaxed">
                      To achieve the same placement flexibility and accuracy in interpreting the signals, Limitless Brain Lab adds an external gold-cup electrode to the Muse headset
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex justify-center order-1 md:order-2">
                <div className="relative bg-gradient-to-br from-[#F5D05D]/10 to-gray-100 rounded-3xl p-8">
                  <img
          ...
          <div className="mb-20">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {/* Research Card 1 */}
              <div className="group bg-gradient-to-br from-white to-gray-50 border-2 border-gray-200 rounded-3xl p-8 hover:border-[#F5D05D] hover:shadow-2xl transition-all duration-300">
                <div className="w-14 h-14 bg-[#F5D05D]/10 rounded-2xl flex items-center justify-center mb-6 group-hover:bg-[#F5D05D] transition-colors">
                  <TrendingUp className="w-7 h-7 text-[#F5D05D] group-hover:text-white transition-colors" />
                </div>
              ...
              <div className="group bg-gradient-to-br from-white to-gray-50 border-2 border-gray-200 rounded-3xl p-8 hover:border-[#F5D05D] hover:shadow-2xl transition-all duration-300">
                <div className="w-14 h-14 bg-[#F5D05D]/10 rounded-2xl flex items-center justify-center mb-6 group-hover:bg-[#F5D05D] transition-colors">
                  <Brain className="w-7 h-7 text-[#F5D05D] group-hover:text-white transition-colors" />
                </div>
                <h3 className="text-2xl font-bold text-gray-900 mb-4">
                  Brain Plasticity
                </h3>
              ...
              <div className="group bg-gradient-to-br from-white to-gray-50 border-2 border-gray-200 rounded-3xl p-8 hover:border-[#F5D05D] hover:shadow-2xl transition-all duration-300">
                <div className="w-14 h-14 bg-[#F5D05D]/10 rounded-2xl flex items-center justify-center mb-6 group-hover:bg-[#F5D05D] transition-colors">
                  <Award className="w-7 h-7 text-[#F5D05D] group-hover:text-white transition-colors" />
                </div>
                <h3 className="text-2xl font-bold text-gray-900 mb-4">
                  Clinical Validation
                </h3>
              ...
              <div className="group bg-gradient-to-br from-white to-gray-50 border-2 border-gray-200 rounded-3xl p-8 hover:border-[#F5D05D] hover:shadow-2xl transition-all duration-300">
                <div className="w-14 h-14 bg-[#F5D05D]/10 rounded-2xl flex items-center justify-center mb-6 group-hover:bg-[#F5D05D] transition-colors">
                  <Activity className="w-7 h-7 text-[#F5D05D] group-hover:text-white transition-colors" />
                </div>
                <h3 className="text-2xl font-bold text-gray-900 mb-4">
                  Peak Performance
                </h3>
          ...
          <div className="mb-20">
            <div className="bg-gradient-to-br from-[#C8E6E1] to-[#F5D05D]/20 rounded-3xl p-8 sm:p-10 md:p-12 shadow-xl">
              ...
              <div className="space-y-8 text-lg text-gray-700">
                <div className="flex items-start gap-4">
                  <div className="flex-shrink-0 w-10 h-10 bg-[#F5D05D] text-white rounded-full flex items-center justify-center font-bold">
                    1
                  </div>
                  <div>
            ...
            <div className="bg-gradient-to-br from-gray-50 to-white rounded-3xl p-8 sm:p-10 md:p-12 border-2 border-gray-200 shadow-xl">
              <ul className="grid md:grid-cols-2 gap-6 text-lg text-gray-700">
                <li className="flex items-start gap-3">
                  <span className="text-[#F5D05D] text-2xl">✓</span>
          ...
          {/* CTA Section */}
          <div className="relative overflow-hidden bg-gradient-to-br from-gray-900 via-gray-800 to-[#F5D05D] rounded-3xl p-12 sm:p-16 shadow-2xl">
            <div className="absolute top-0 right-0 w-64 h-64 bg-[#F5D05D]/20 rounded-full blur-3xl"></div>
            ...
            <div className="relative text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <a
                  href="/register"
                  className="group inline-flex items-center justify-center gap-2 px-8 py-4 bg-[#F5D05D] hover:bg-[#E5C04D] text-white rounded-full text-lg font-medium transition-all hover:scale-105 shadow-lg"
                >
                  Get Started Today
